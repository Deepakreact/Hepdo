                           ...
                           <div className="form-group mb-0">
                              <div id="pricing_select">
                                 <div className="custom-control form-check custom-control-inline">
                                    <input type="radio" id="price_free" name="rating_option" className="form-check-input" value="price_free" checked />
                                    <label className="form-check-label" for="price_free">Free</label>
                                 </div>
                                 <div className="custom-control form-check custom-control-inline">
                                    <input type="radio" id="price_custom" name="rating_option" value="custom_price" className="form-check-input" />
                                    <label className="form-check-label" for="price_custom">Custom Price (per hour)</label>
                                 </div>
                              </div>
                           </div>
